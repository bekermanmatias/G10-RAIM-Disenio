...
import RequirementDetail from './components/requirements/RequirementDetail'; // Importa el nuevo componente
            ...
            <div className="container">
                ...
                <main className="main-content">
                    <Routes>
                        ...
                        <Route path="/requirements/:codigo" element={<RequirementDetail />} /> {/* Nueva ruta de detalle */}
